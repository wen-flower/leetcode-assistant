...
class LoadNextPageAction : AnAction(), Disposable {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        scope.launch {
            val result = questionListService.next()
            if (!result) {
    ...
    override fun update(e: AnActionEvent) {
        e.presentation.isEnabled = questionListService.loading.not()
            .and(questionListService.skip + questionListService.limit < questionListService.total)
    }
